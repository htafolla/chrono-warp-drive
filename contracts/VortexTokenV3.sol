...
contract VortexTokenV3 is ERC721Enumerable, AccessControl {
    ...
    constructor(address _registry, address _treasury) ERC721("Dynamo Vortex", "VRTX") {
        ...
        _contractURI = string.concat(
            "data:application/json;base64,",
            Base64.encode(bytes(string.concat(
                '{"name":"Dynamo Vortex","description":"',
                unicode'A temporal resonance vortex captured by the Dynamo engine.',
                '","image":"https://mcp-production-80e2.up.railway.app/vortex/collection-image",',
                '"external_link":"https://dynamo.rippel.ai",',
                '"seller_fee_basis_points":500,',
                '"fee_recipient":"', Strings.toHexString(_treasury), '"}'
            )))
        );
    }
